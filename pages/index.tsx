...
export default function Home() {
  return (
    <main
      className={`flex min-h-screen flex-col items-center sm:items-start justify-start sm:justify-end p-4 sm:p-24 ${inter.className}`}
    >
      <div className="grid grid-cols-[1fr,2fr] gap-x-8">
